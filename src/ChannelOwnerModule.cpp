...
EPChannelOwnerModule::EPChannelOwnerModule(uint8_t numberOfChannels)
...
EPChannelOwnerModule::~EPChannelOwnerModule()
{
...
void EPChannelOwnerModule::setup(bool configured)
{
    OpenKNX::Module::setup(configured);
}

OpenKNX::Channel* EPChannelOwnerModule::createChannel(uint8_t _channelIndex /* this parameter is used in macros, do not rename */)
{
    return nullptr;
}

void EPChannelOwnerModule::setup()
{
...
void EPChannelOwnerModule::loop(bool configured)
{
...
void EPChannelOwnerModule::loop()
{
    OpenKNX::Module::loop();
    if (_pChannels != nullptr)
    {
...
uint8_t EPChannelOwnerModule::getNumberOfUsedChannels()
{
...
uint8_t EPChannelOwnerModule::getNumberOfChannels()
{
    return _numberOfChannels;
}

OpenKNX::Channel* EPChannelOwnerModule::getChannel(uint8_t channelIndex)
{
    return _pChannels != nullptr ? _pChannels[channelIndex] : nullptr;
}

#ifdef OPENKNX_DUALCORE
void EPChannelOwnerModule::setup1(bool configured)
{
...
void EPChannelOwnerModule::setup1()
{
...
void EPChannelOwnerModule::loop1(bool configured)
{
...
void EPChannelOwnerModule::loop1()
{
...
void EPChannelOwnerModule::processInputKo(GroupObject &ko)
{
